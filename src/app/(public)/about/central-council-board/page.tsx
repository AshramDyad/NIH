...
const councilMembers: CouncilMember[] = [
  ...
  },
  {
    ...
    details:
      "LAJPATRAI MEHRA NEUROTHERAPY RESEARCH AND TRAINING INSTITUTE (LMNTRTI)CHANDIGARH",
  ...
  },
  {
    ...
    details:
      "Samshudhi Residential Naturopathy and Panchkarma Hospital, Gurgaon",
  ...
  },
  {
    ...
    details:
      "Guru Ramrai University-Dehradun,Director-Arogyam Yog Prakritik Chikitsa Kendra",
    category: "SECRETARY",
  ...
  },
  {
    ...
    name: "Anurag, Delhi",
    designation:
      "Secretary-NIH, IT Head, Social Media Promoter, Graphics Designer",
    details: "",
    category: "SECRETARY",
      ...
      <section className={newLocal}>
        ...
        <div className="space-y-12">
          {categories.map((category) => {
            const membersInCategory = councilMembers.filter(
