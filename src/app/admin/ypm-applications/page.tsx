...
export default function AdminYPMApplicationsPage() {
  ...
  const [selectedApplication, setSelectedApplication] =
    useState<YPMApplication | null>(null);
  ...
  const handleApprove = async () => {
    ...
    try {
      const result = await approveYPMApplication(
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage Yoga Professional Member applications
          </p>
        </div>

        {/* Status Filter Tabs */}
        <div className="flex gap-2 bg-gray-100 rounded-lg p-1">
          {(["all", "approved", "rejected", "pending"] as StatusFilter[]).map(
            (status) => (
              <button
                key={status}
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            title={
                              app.status === "pending" ? "Reject" : "Delete"
                            }
                          >
            ...
            <div className="px-6 py-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  Enter unique member ID to approve
                </p>
              </div>
            ...
            <div className="px-6 py-6 space-y-4">
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <p className="text-sm text-red-900 leading-relaxed">
                  ...
                  application and all associated records/files for{" "}
                  <strong>
                    {selectedApplication.first_name}{" "}
                    {selectedApplication.last_name}
                  </strong>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({
                        ...editForm,
                        referredByMobile: e.target.value,
                      })
                    }
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-500"
                  />
            ...
            <div className="px-6 py-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {selectedApplication.referred_by_name || "N/A"}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium text-gray-500">
                  ...
                  <p className="text-gray-900">
                    {selectedApplication.referred_by_mobile || "N/A"}
                  </p>
                </div>
              </div>
