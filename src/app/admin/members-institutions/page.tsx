...
} from "@/app/actions/institutionMembers";
    ...
    try {
      ...
      if (editingInstitution) {
        result = await updateInstitutionMember(
          editingInstitution.id.toString(),
          formDataObj
        );
      } else {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Manage institutions and centers registered with NIH
          </p>
        </div>
        <button
      ...
      {!error && (
        <DataTable<InstitutionMember>
          ...
          emptyIcon={<Building2 className="w-16 h-16 text-gray-400" />}
          emptyTitle="No Institutions Yet"
          emptyDescription="Get started by adding your first institution member."
        />
      )}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. Bharatiya Vidya Bhavan"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-blue-500 h-24"
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  <button
                    ...
                    disabled={
                      isSubmitting ||
                      (!formData.imageUrl && !editingInstitution)
                    }
                    className="flex-1 bg-primary hover:bg-orange-600 disabled:bg-gray-400 text-white font-medium py-2.5 px-4 rounded-lg flex items-center justify-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
                        <Loader2 className="w-5 h-5 animate-spin" />{" "}
                        {editingInstitution ? "Updating..." : "Adding..."}
                      </>
                    ) : editingInstitution ? (
                      "Update"
                    ) : (
