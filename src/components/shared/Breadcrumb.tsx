 ...
 */
const DISABLED_PATHS = ['/about', '/academics', '/general-information', '/global-links', '/about-dps', '/about-dps/dps-family', '/infrastructure', '/infrastructure/laboratories', '/activities'];
