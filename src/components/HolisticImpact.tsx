...
import { getGalleryImages } from "@/app/actions/nih-gallery";
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div className="group bg-white rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.2)] transition-transform duration-300 flex flex-col relative">
            ...
            <div className="p-6 flex flex-col grow">
              <div className="flex items-center gap-5 mb-8">
                ...
                <div>
                  <h3 className="text-secondary font-sans font-bold text-xl tracking-tight">
                    Dr. Vinod Kashyap
                  </h3>
                  <p className="text-primary font-sans font-semibold text-xs uppercase tracking-widest mt-1">
                    Chairman, NIH
                  </p>
                </div>
              </div>
              <div className="grow">
                <div className="mb-6">
                  <p className="text-gray-600 italic font-serif leading-relaxed text-lg">
                    &ldquo;Health is the biggest necessity in today&apos;s life.
                    We have to correct our diet, our thoughts and our behavior
                    to keep our health constant...&rdquo;
                  </p>
                </div>
              </div>
              <div className="mt-8 flex items-center justify-between pt-6 border-t border-gray-100">
                <Link
                  href="/about/chairman"
                  className="text-gray-900 font-sans font-bold text-sm hover:text-primary transition-colors flex items-center gap-1 group/link"
                >
                  Read Full Story{" "}
          ...
          <div className="group bg-white rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.2)] transition-transform duration-300 flex flex-col relative">
            <div className="h-2 w-full bg-primary" />
            <div className="p-6 flex flex-col grow">
              <h3 className="text-secondary font-sans font-bold text-xl tracking-tight mb-8">
                Quick Links
              </h3>
              <div className="grid grid-cols-1 gap-4 grow">
                {[
                  ...
                  {
                    title: "Affiliation",
                    color: "hover:bg-[#D3B6F0]",
                    href: "https://forms.gle/469FAG4UTLDvVaTy6",
                    isExternal: true,
                  },
                  {
                    title: "Certificate Course in Holistic Health",
                    color: "hover:bg-[#B2D1F2]",
                    href: "https://forms.gle/X1vFV8VqQSRfTics7",
                    isExternal: true,
                  },
                ].map((activity, idx) => (
                  <Link
                    ...
                    rel={
                      activity.isExternal ? "noopener noreferrer" : undefined
                    }
